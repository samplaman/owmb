...
class Dilator
{
  ...
  public:
    ...
    //! dilate.
    //!	\param dilate_end is (one-past) the end of a sequence of Partials to
    //! dilate.
    //!
...
template <typename Iter>
void
Dilator::dilate(Iter dilate_begin, Iter dilate_end) const
{
...
template <typename Iter>
void
Dilator::operator()(Iter dilate_begin, Iter dilate_end) const
{
...
//
inline void
Dilator::operator()(Partial &p) const
{
    dilate(p);
}
...
//
inline void
Dilator::operator()(Marker &m) const
{
    dilate(m);
}
...
template <typename PartialsIter, typename TimeIter1, typename TimeIter2>
void
Dilator::dilate(PartialsIter dilate_begin, PartialsIter dilate_end,
                TimeIter1 ibegin, TimeIter1 iend, TimeIter2 tbegin)
{
