/* rndlcg            Linear Congruential Method, the "minimal standard
   generator" Park & Miller, 1988, Comm of the ACM, 31(10), pp. 1192-1201
...
unsigned long int
randlcg(void) /* returns a random unsigned integer */
{
