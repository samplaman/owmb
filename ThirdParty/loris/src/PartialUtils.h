...
template <class Arg>
void
scaleAmplitude(Partial &p, const Arg &arg)
{
...
void
scaleAmplitude(Iter b, Iter e, const Arg &arg)
{
    AmplitudeScaler scaler(arg);
    while (b != e)
    {
...
template <class Arg>
void
scaleBandwidth(Partial &p, const Arg &arg)
{
...
template <class Iter, class Arg>
void
scaleBandwidth(Iter b, Iter e, const Arg &arg)
{
    BandwidthScaler scaler(arg);
    while (b != e)
    {
...
template <class Arg>
void
setBandwidth(Partial &p, const Arg &arg)
{
...
template <class Iter, class Arg>
void
setBandwidth(Iter b, Iter e, const Arg &arg)
{
    BandwidthSetter setter(arg);
    while (b != e)
    {
...
template <class Arg>
void
scaleFrequency(Partial &p, const Arg &arg)
{
...
template <class Iter, class Arg>
void
scaleFrequency(Iter b, Iter e, const Arg &arg)
{
    FrequencyScaler scaler(arg);
    while (b != e)
    {
...
template <class Arg>
void
scaleNoiseRatio(Partial &p, const Arg &arg)
{
...
template <class Iter, class Arg>
void
scaleNoiseRatio(Iter b, Iter e, const Arg &arg)
{
    NoiseRatioScaler scaler(arg);
    while (b != e)
    {
...
template <class Arg>
void
shiftPitch(Partial &p, const Arg &arg)
{
...
template <class Iter, class Arg>
void
shiftPitch(Iter b, Iter e, const Arg &arg)
{
    PitchShifter shifter(arg);
    while (b != e)
    {
...
//
inline void
crop(Partial &p, double t1, double t2)
{
...
template <class Iter>
void
crop(Iter b, Iter e, double t1, double t2)
{
    Cropper cropper(t1, t2);
    while (b != e)
    {
...
//
inline void
shiftTime(Partial &p, double offset)
{
...
template <class Iter>
void
shiftTime(Iter b, Iter e, double offset)
{
    TimeShifter shifter(offset);
    while (b != e)
    {
...
template <class Iter>
void
fixPhaseBefore(Iter b, Iter e, double t)
{
    while (b != e)
    {
        fixPhaseBefore(*b, t);
...
template <class Iter>
void
fixPhaseAfter(Iter b, Iter e, double t)
{
    while (b != e)
    {
        fixPhaseAfter(*b, t);
...
template <class Iter>
void
fixPhaseForward(Iter b, Iter e, double tbeg, double tend)
{
    while (b != e)
    {
...
template <class Iter>
void
fixPhaseAt(Iter b, Iter e, double t)
{
    while (b != e)
    {
        fixPhaseAt(*b, t);
...
template <class Iter>
void
fixPhaseBetween(Iter b, Iter e, double t1, double t2)
{
    while (b != e)
    {
