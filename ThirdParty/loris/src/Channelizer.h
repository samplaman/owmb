...
class Channelizer
{
  ...
  public:
    ...
    //! channels, constructed from the same reference Envelope and channel
    //! number as rhs.
    //!
    ...
    //! \param      m is the harmonic number of the harmonic whose frequnecy is
    //! fm
    //! \param      fn is the frequency of the Nth stretched harmonic
    //! \param      n is the harmonic number of the harmonic whose frequnecy is
    //! fn
...
template <typename Iter>
void
Channelizer::channelize(Iter begin, Iter end) const
{
    while (begin != end)
    {
        channelize(*begin++);
...
template <typename Iter>
void
Channelizer::channelize(Iter begin, Iter end, const Envelope &refChanFreq,
                        int refChanLabel)
{
