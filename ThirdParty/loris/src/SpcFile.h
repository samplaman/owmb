...
class SpcFile
{
  ...
  public:
    ...
    //! transition
    //!			to a static spectrum at the end of the sound (default 0)
    void writeSinusoidal(const std::string &filename,
...
//!			(default is 60)
template <typename Iter>
SpcFile::SpcFile(Iter begin_partials, Iter end_partials,
                 double midiNoteNum) : //	initializers:
...
template <typename Iter>
void
SpcFile::addPartials(Iter begin_partials, Iter end_partials)
{
